-- XENO SHIP BUILDER - FIXED VERSION
print("🚢 XENO SHIP BUILDER LOADED!")
...
local function buildBasicShip()
    ...
    cockpit.Size = Vector3.new(6, 4, 5)
    cockpit.Position = hull.Position + Vector3.new(0, 5, 4)
    ...
    for i = -1, 1, 2 do
        ...
        engine.Size = Vector3.new(4, 4, 8)
        engine.Position = hull.Position + Vector3.new(i * 8, 0, -10)
...
-- Создаем кнопки
CreateButton("🚢 Построить корабль", buildBasicShip)
CreateButton("🔗 Сварить детали", autoWeld)
CreateButton("🚀 Включить движение", function()
    if currentShip then
